...
module.exports.run = async message => {
  ...
  message.channel.send({
    embed: {
      ...
      description: "The Impostor is a simple bot that helps you host Among us-games through Discord voice chat. With a simple setup, your hosting panel is ready.",
      color: config.color,
      timestamp: Date.now(),
      footer: {
